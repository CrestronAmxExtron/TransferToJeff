...
VOLATILE CHAR 	M4IPAddress[15]			=		'192.168.1.52'
...
{
    IP_CLIENT_OPEN (dvMic4.PORT, '192.168.1.26',2202, 1)
}
...
BUTTON_EVENT[dvIpad,VTCSources]
{
	...
	SWITCH(BUTTON.INPUT.CHANNEL)
	{
	    CASE 700:SEND_COMMAND dvSwitcher,"'VI9O3'";		RoutedToVTC = 9;	SEND_COMMAND dvSwitcher,"'VI9O6'";  	
	    CASE 701:SEND_COMMAND dvSwitcher,"'VI10O3'";	RoutedToVTC = 10;	SEND_COMMAND dvSwitcher,"'VI10O6'";	
	    CASE 702:SEND_COMMAND dvSwitcher,"'VI11O3'";	RoutedToVTC = 11;	SEND_COMMAND dvSwitcher,"'VI11O6'";	
	    CASE 703:SEND_COMMAND dvSwitcher,"'VI12O3'";	RoutedToVTC = 12;	SEND_COMMAND dvSwitcher,"'VI12O6'";	
	    CASE 704:SEND_COMMAND dvSwitcher,"'VI3O3'";		RoutedToVTC = 3;	SEND_COMMAND dvSwitcher,"'VI3O6'";		
	    CASE 705:SEND_COMMAND dvSwitcher,"'VI8O3'";		RoutedToVTC = 8;	SEND_COMMAND dvSwitcher,"'VI8O6'";	
	    CASE 706:SEND_COMMAND dvSwitcher,"'VI4O3'";		RoutedToVTC = 4;	SEND_COMMAND dvSwitcher,"'VI4O6'";	
	    CASE 707:SEND_COMMAND dvSwitcher,"'VI5O3'";		RoutedToVTC = 5;	SEND_COMMAND dvSwitcher,"'VI5O6'";	
	    CASE 708:SEND_COMMAND dvSwitcher,"'VI6O3'";		RoutedToVTC = 6;	SEND_COMMAND dvSwitcher,"'VI6O6'";		
	    CASE 709:SEND_COMMAND dvSwitcher,"'VI7O3'";		RoutedToVTC = 7;	SEND_COMMAND dvSwitcher,"'VI7O6'";	
	}
    }
}
BUTTON_EVENT[dvIpad,BasicSources]
{
	...
	SWITCH(BUTTON.INPUT.CHANNEL)
	{
	    CASE 600:SEND_COMMAND dvSWITCHER,"'VI9O1'";SEND_COMMAND dvSWITCHER,"'VI9O2'";RoutedToLeftDisplay = 1;RoutedToRightDisplay = 1;RoutedBasic = 9; SEND_COMMAND dvSwitcher,"'VI9O6'";		LastRoutedProgramAudio = 9;//Route North HDMI Video to Both displays
	    CASE 601:SEND_COMMAND dvSWITCHER,"'VI10O1'";SEND_COMMAND dvSWITCHER,"'VI10O2'";RoutedToLeftDisplay = 2;RoutedToRightDisplay = 2;;RoutedBasic = 10; SEND_COMMAND dvSwitcher,"'VI10O6'";	LastRoutedProgramAudio = 10;//Route Center HDMI Video to Both displays
	    CASE 602:SEND_COMMAND dvSWITCHER,"'VI11O1'";SEND_COMMAND dvSWITCHER,"'VI11O2'";RoutedToLeftDisplay = 3;RoutedToRightDisplay = 3;;RoutedBasic = 11; SEND_COMMAND dvSwitcher,"'VI11O6'";	LastRoutedProgramAudio = 11;//Route South HDMI Video to Both displays
	    CASE 603:SEND_COMMAND dvSWITCHER,"'VI12O1'";SEND_COMMAND dvSWITCHER,"'VI12O2'";RoutedToLeftDisplay = 4;RoutedToRightDisplay = 4;;RoutedBasic = 12; SEND_COMMAND dvSwitcher,"'VI12O6'";	LastRoutedProgramAudio = 12;//Route Lectern HDMI Video to Both displays
...
BUTTON_EVENT[dvIpad,233]								//Left Display
{
    ...
    {
	RoutedBasic = 0;
	IF     (CurrentlySelectedSource = 1) {SEND_COMMAND dvSWITCHER,"'VI9O1'";RoutedToLeftDisplay = 1;	IF(SelectedAudioScreen = 1)	{SEND_COMMAND dvSwitcher,"'VI9O6'";	LastRoutedProgramAudio = 9;}}//Route North HDMI Video to left display
	ELSE IF(CurrentlySelectedSource = 2) {SEND_COMMAND dvSWITCHER,"'VI10O1'";RoutedToLeftDisplay = 2;	IF(SelectedAudioScreen = 1)	{SEND_COMMAND dvSwitcher,"'VI10O6'";	LastRoutedProgramAudio = 10;}}//Route Center HDMI Video to left display
	ELSE IF(CurrentlySelectedSource = 3) {SEND_COMMAND dvSWITCHER,"'VI11O1'";RoutedToLeftDisplay = 3;	IF(SelectedAudioScreen = 1)	{SEND_COMMAND dvSwitcher,"'VI11O6'";	LastRoutedProgramAudio = 11;}}//Route South HDMI Video to left display
	ELSE IF(CurrentlySelectedSource = 4) {SEND_COMMAND dvSWITCHER,"'VI12O1'";RoutedToLeftDisplay = 4;	IF(SelectedAudioScreen = 1)	{SEND_COMMAND dvSwitcher,"'VI12O6'";	LastRoutedProgramAudio = 12;}}//Route Lectern HDMI Video to left display
...
BUTTON_EVENT[dvIpad,234]								//Right Display
{
    ...
    {
	RoutedBasic = 0;
	IF(CurrentlySelectedSource = 1)	     {SEND_COMMAND dvSWITCHER,"'VI9O2'";RoutedToRightDisplay = 1;	IF(SelectedAudioScreen = 2)	{SEND_COMMAND dvSwitcher,"'VI9O6'";	LastRoutedProgramAudio = 9;}}//Route North HDMI Video to right display
	ELSE IF(CurrentlySelectedSource = 2) {SEND_COMMAND dvSWITCHER,"'VI10O2'";RoutedToRightDisplay = 2;	IF(SelectedAudioScreen = 2)	{SEND_COMMAND dvSwitcher,"'VI10O6'";	LastRoutedProgramAudio = 10;}}//Route Center HDMI Video to right display
	ELSE IF(CurrentlySelectedSource = 3) {SEND_COMMAND dvSWITCHER,"'VI11O2'";RoutedToRightDisplay = 3;	IF(SelectedAudioScreen = 2)	{SEND_COMMAND dvSwitcher,"'VI11O6'";	LastRoutedProgramAudio = 11;}}//Route South HDMI Video to right display
	ELSE IF(CurrentlySelectedSource = 4) {SEND_COMMAND dvSWITCHER,"'VI12O2'";RoutedToRightDisplay = 4;	IF(SelectedAudioScreen = 2)	{SEND_COMMAND dvSwitcher,"'VI12O6'";	LastRoutedProgramAudio = 12;}}//Route Lectern HDMI Video to right display
