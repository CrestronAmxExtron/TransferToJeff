...
BUTTON_EVENT[dvIpad,VTCSources]
{
	...
	SWITCH(BUTTON.INPUT.CHANNEL)
	{
	    ...
	    CASE 701:SEND_COMMAND dvSwitcher,"'VI10O3'";	RoutedToVTC = 10;	SEND_COMMAND dvSwitcher,"'AI10O3'";
	    CASE 702:SEND_COMMAND dvSwitcher,"'VI11O3'";	RoutedToVTC = 11;	SEND_COMMAND dvSwitcher,"'AI11O3'";
	    CASE 703:SEND_COMMAND dvSwitcher,"'VI12O3'";	RoutedToVTC = 12;	SEND_COMMAND dvSwitcher,"'AI12O3'";
	    CASE 704:SEND_COMMAND dvSwitcher,"'VI3O3'";		RoutedToVTC = 3;	SEND_COMMAND dvSwitcher,"'AI3O3'";		
	    CASE 705:SEND_COMMAND dvSwitcher,"'VI8O3'";		RoutedToVTC = 8;	SEND_COMMAND dvSwitcher,"'AI8O3'";
	    CASE 706:SEND_COMMAND dvSwitcher,"'VI4O3'";		RoutedToVTC = 4;	SEND_COMMAND dvSwitcher,"'AI4O3'";
	    CASE 707:SEND_COMMAND dvSwitcher,"'VI5O3'";		RoutedToVTC = 5;	SEND_COMMAND dvSwitcher,"'AI5O3'";
	    CASE 708:SEND_COMMAND dvSwitcher,"'VI6O3'";		RoutedToVTC = 6;	SEND_COMMAND dvSwitcher,"'AI6O3'";	
	    CASE 709:SEND_COMMAND dvSwitcher,"'VI7O3'";		RoutedToVTC = 7;	SEND_COMMAND dvSwitcher,"'AI7O3'";
	}
    }
}
