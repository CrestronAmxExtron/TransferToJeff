...
//dvSOUNDWEB = 5001:2:0 //real device RS232 port 2
dvSOUNDWEB = 0:4:0 //real device RS232 port 2
#END_IF
...
N_GAIN = 10; INPUT_CARD = 11; OUTPUT_CARD = 12; ROOM_COMBINE = 26; TELEPHONE = 27;

(* PARAMETER CONSTANTS <PARAM> FUNCTION PARAMETER  *)
UNMUTE = 0; MUTE = 1; ROUTE = 1; GAIN = 3;UNROUTE = 0;  
POLARITY_ON = 1; POLARITY_OFF = 0;
...
BUTTON_7 = 45; BUTTON_8 = 46; BUTTON_9 = 47; PAUSE = 48; CLEAR = 49; INTERNATIONAL = 50; BACKSPACE = 51;
...
CHAR FB[270][12]; //FEEDBACK ARRAY - MUST MANUALLY ASSIGN DIMENSION OF ROWS[1] IF OVER 200 VARIABLES ARE USED FOR TRUE FEEDBACK (ie MAKE LARGER IF NEEDED); COLUMN[2] MUST ALWAYS BE 12!!
...
LOCAL_VAR CHAR CS;
    ...
    send_string 0,"'to DSP: ',data.text"
...
CREATE_BUFFER dvSOUNDWEB,cBUFFER
CLEAR_BUFFER cBUFFER
bDEBUG_FLAG = 2

IP_CLIENT_OPEN (dvSOUNDWEB.port,cServerAddress,lServerPort,1);
...
DATA_EVENT [dvSOUNDWEB]
{
    ONLINE:
    {
	SEND_COMMAND dvSOUNDWEB, 'SET BAUD 115200,N,8,1 485 DISABLE'
    }
    STRING:
    {
 	    IF(bDEBUG_FLAG==2) // if full debug ON, print everything...
		fnLog_Hex(cBUFFER,LENGTH_STRING(cBUFFER),'received  <-- ')
            WHILE(fnParseRx(cBUFFER)) {/*DO NOTHING*/}
    }
}
*/
...
DATA_EVENT [dvSOUNDWEB]
{
    ...
    STRING:
    {
	send_string 0,"'from DSP: ',data.text"
 	    IF(bDEBUG_FLAG==2) // if full debug ON, print everything...
		fnLog_Hex(cBUFFER,LENGTH_STRING(cBUFFER),'received  <-- ')
            WHILE(fnParseRx(cBUFFER)) {/*DO NOTHING*/}
    }
